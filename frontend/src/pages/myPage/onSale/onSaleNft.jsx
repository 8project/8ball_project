        ...
        <Box>
            <Box className="flex flex-cols justify-center items-center border rounded-md px-4 py-2">
                <Text className="font-[Tenada]">
                    <span className="text-blue-600">소유한</span> NFT의 판매를{" "}
                                ...
                                <Box className="flex flex-col justify-center items-center border rounded-md mb-10 ">
                                    ...
                                    <Box className="bg-gray-100 w-full px-4 py-1 font-semibold">
                                        ...
                                        <Button
                                            ...
                                            className="justify-center text-center w-full py-4 mt-2"
                                        >
                                            Duration
                                        </Button>
                                        <Button
