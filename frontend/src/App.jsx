...
import OnSale from "./pages/myPage/onSale/onSale";
      ...
      <Box className="relative">
        ...
        <Box className="flex justify-center lg:min-w-[800px] lg:max-w-[800px] min-w-[460px] max-w-[460px]  min-h-screen bg-white">
          <Routes>
            ...
            <Route
              path="/pieceMarket"
              element={<PieceMarket account={account} />}
            />
            ...
            <Route
              path="/mypage/myPieceNft"
              element={<MyPieceNft account={account} />}
            />
            <Route
              path="/mypage/inProgress"
              element={<InProgress account={account} />}
            />
            <Route
              path="/mypage/onSale"
              element={<OnSale account={account} />}
            />
          </Routes>
        </Box>
        <BottomMenu />
